...
import time
from Cutscenes.scene_0_5 import Scene05
...
class Scene0():
    ...
    def __init__(self, core: Core):
        ...
        self.Text = [
            "Amuse-toi bien, ma cherie !",
            "Oui, maman.",
            "Je sais que le premier jour dans une nouvelle ecole ٲpeut etre impressionnant",
            "Mais rassure-toi, je suis sure que tu vas parfaitement ٲt'integrer.",
            "Oui, oui, voila, a ce soir.",
            "A ce soir, ma cherie, et rappelle-toi d'une chose...",
            "Je t'aime."
        ]
    ...
    def _setup_scene(self):
        ...
        self.scene.Entity("bg", size=Vec2(1920, 1080), position=Vec2(0, 0), 
                          ...
                          texture="Assets/Textures/Cutscenes/0/1.raw")
