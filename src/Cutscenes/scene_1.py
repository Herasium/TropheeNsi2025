...
import time
from Cutscenes.scene_1_5 import Scene1_5
...
class Scene1():
    ...
    def __init__(self, core: Core):
        ...
        self.Text = [
    "Alors ma cherie, cette premiere journee?",
    "Oui tres bien.",
    "Tu vois qu'il n'y avait pas a s'inquieter.",
    "Viens donc t'installer, le repas est servi."
]
    ...
    def _setup_scene(self):
        ...
        self.scene.Entity("bg", size=Vec2(1920, 1080), position=Vec2(0, 0), 
                          ...
                          texture="Assets/Textures/Cutscenes/1/0.raw")
