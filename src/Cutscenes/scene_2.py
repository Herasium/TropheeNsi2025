...
class Scene2():
    ...
    "tu penses?",
    "mais oui!",
    "ahah j'aurais pas aime etre a sa place..",
    "tu te rends compte!",
    "elle fait vraiment pitie.",
    "Brenda avait raison elle craint vraiment..",
    "tant qu'elle reste loin de moi.",
    "la pauvre quand meme!",
    "mais non elle le merite.",
    "en meme temps quand brenda t'as dans le viseur...",
    "c'est la mort.",
    "la mort.",
    "la mort.",
    "mort.",
    ...
    def _setup_scene(self):
        ...
        self.scene.Entity("bg", size=Vec2(1920, 1080), position=Vec2(0, 0), 
                          ...
                          texture="Assets/Textures/Cutscenes/2/0.raw")
