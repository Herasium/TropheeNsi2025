...
class Scene4():
    ...
    def __init__(self, core: Core):
        ...
        self.Text = [
    "Prune n'a pas survecu a sa chute mortelle.",
    "Toutes nos condoleances vont a sa famille.",
    "Au lycee en France, 1 eleve sur 20 estٲvictime de harcelement.",
    "Parmi eux, seulement 1 sur 5 a su demander de l'aide.",
    "Si vous ou un proche etes victimes/temoins de harcelement..",
    "30 18, numero unique contre le harcelement.",
    "Merci d'avoir suivi cette histoire.",
    "Signe Mateo et Victor."
]
    ...
    def _setup_scene(self):
        ...
        self.scene.Entity("bg", size=Vec2(1920, 1080), position=Vec2(0, 0), 
                          color=Color(0, 0, 0), layer=layers.background, 
                          )
