...
class Dream45:
    def __init__(self,core: Core):
        ...
        self._core.log.INFO("Dream 4.5 transition launched.")
    ...
    def _setup_transition(self):
        ...
        self.transition_collection.Entity("one",layer=layers.background,position = Vec2(1060,-490),size=Vec2(30,52),texture="Assets/Textures/Transition/Dream1/4.raw.corrupted")
    ...
    def update(self,_):
        if self.in_transition == True:
            ...
            self._core.log.INFO("Launching PacMan.")
            self._core.corrupted = PacManCorrupted(self._core)
            self._core.corrupted.setup()
